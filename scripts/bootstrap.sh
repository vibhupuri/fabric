...
dockerPull() {
    ...
    do
        ...
        nerdctl pull "hyperledger/fabric-$image_name:$three_digit_image_tag"
        nerdctl tag "hyperledger/fabric-$image_name:$three_digit_image_tag" "hyperledger/fabric-$image_name"
        nerdctl tag "hyperledger/fabric-$image_name:$three_digit_image_tag" "hyperledger/fabric-$image_name:$two_digit_image_tag"
        shift
    done
}
...
pullDockerImages() {
    ...
    if [ "${NODOCKER}" == 0 ]; then
        ...
        nerdctl images | grep hyperledger
    else
        echo "========================================================="
